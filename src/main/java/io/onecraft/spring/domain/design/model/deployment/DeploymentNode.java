 ...
 * @version 1.0
 */
public record DeploymentNode(Long id, String name, @DeploymentNodeType String type, String location,
                             Set<@Valid NodeResource> resources,
                             Set<@Valid DeployedSoftwareComponent> deployedComponents) {
}
