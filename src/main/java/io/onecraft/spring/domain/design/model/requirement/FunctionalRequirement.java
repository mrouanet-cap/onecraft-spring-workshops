...
/**
 * This class represents the functional requirements of a project.
 *
 ...
 *                               (e.g. open, closed, in-progress, etc.)
 * @param requirementCategory    Category of the requirement.
 *                               (e.g. UI, backend, database, etc.)
 * @param requirementOwner       Owner of the requirement.
 *                               (e.g. developer, tester, product owner, etc.)
 * @param requirementReviewer    Reviewer of the requirement.
 *                               (e.g. architect, lead developer, etc.)
 ...
 * @param requirementDueDate     The date when the requirement is due.
 *                               (e.g. the date when the requirement should be implemented)
 ...
 * @version 1.0
 */
public record FunctionalRequirement(@RequirementId(pattern = "^FR-[0-9]{1,4}$") String requirementId,
                                    ...
                                    List<@Valid RequirementAttachement> requirementAttachments) {
}
