 ...
 * @version 1.0
 */
public record DeploymentDiagram(Long id, @NotBlank String name, @NotBlank String description,
                                ...
                                Set<@Valid ComponentConnection> connections,
                                Set<@Valid DeploymentNode> nodes) implements Comparable<DeploymentDiagram> {
    @Override
    public int compareTo(DeploymentDiagram o) {
