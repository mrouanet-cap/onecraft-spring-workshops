 ...
 *                    structure.
 */
public record ArchitectureDiagramDto(Long id, @NotBlank String name, @NotBlank String description,
                                     ...
                                     List<String> tags, @ArchitectureDiagramStatus String status,
                                     LocalDate updatedDate,
                                     Set<@Valid SoftwareComponentInterfaceDto> interfaces,
                                     Set<@Valid DataFlowDto> dataFlows, Set<@Valid ArchitecturalConstraintDto> constraints) {
}
